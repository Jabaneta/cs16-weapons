...
scoreboard players set $leg_height temp 79
scoreboard players set $head_height temp 200
...
execute if score $damage temp matches 1.. if score $bodyPart temp matches 2 run particle minecraft:item{item:{id:"red_concrete"}} ~ ~ ~ 0.1 0.1 0.1 0.05 8
execute if score $damage temp matches 1.. if score $bodyPart temp matches 1 run particle minecraft:item{item:{id:"red_concrete"}} ~ ~ ~ 0.1 0.1 0.1 0.05 2
execute if score $damage temp matches 1.. if score $bodyPart temp matches 0 run particle minecraft:item{item:{id:"red_concrete"}} ~ ~ ~ 0.1 0.1 0.1 0.05 2

execute if score $has_crit cs16.gun.data matches 1 run particle minecraft:item{item:{id:"redstone_block"}} ~ ~ ~ 0.2 0.2 0.2 0.15 25

execute if score $damage temp matches ..-1 run particle happy_villager ~ ~ ~ 0.2 0.3 0.2 1 1
