...
execute if score $sneaking temp matches 1 run scoreboard players set $leg_height temp 50
execute if score $sneaking temp matches 1 run scoreboard players set $head_height temp 120
