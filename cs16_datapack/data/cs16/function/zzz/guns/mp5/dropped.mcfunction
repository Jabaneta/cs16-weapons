summon item_display ~ ~ ~ {item:{id:"ender_eye",Count:1b,tag:{CustomModelData:6}},transformation:{left_rotation:[0.707f,0f,0f,0.707f],right_rotation:[0f,0f,0f,1f],translation:[0.0f,0.01f,0.0f],scale:[0.6f,0.6f,0.6f]},Tags:["dropped_gun","mp5","primary"]}
