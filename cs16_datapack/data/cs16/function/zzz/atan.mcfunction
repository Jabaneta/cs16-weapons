...
## a
scoreboard players operation $temp temp = $in1 temp
scoreboard players operation $temp1 temp = $in2 temp
...
execute if score $in1 temp matches ..-1 run scoreboard players operation $result temp *= $-1 const
execute if score $in2 temp matches ..-1 run scoreboard players operation $result temp *= $-1 const
